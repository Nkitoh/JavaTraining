...
public class TypeDesc {
	...
	private static String[]
			basic = {"class", "interface", "enum", "annotation", "nestClass"},
	...
	private void printType(Type type, int depth, String[] labels) {
		...
		//ch05_02.BankAccount$Action
		//nestClass ch05_02.BankAccount.Action Top class:ch05_02.BankAccount
		if (kind == 4) {
			out.print(" Top class:");
			out.print(cls.getDeclaringClass().getCanonicalName());
		}
